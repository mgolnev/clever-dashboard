...
На экранах уже 640 px фильтры занимают доступную ширину, а показатели
сравнения в карточках воронки переносятся на отдельную строку. Навигация
прокручивается горизонтально внутри своей полосы, не расширяя страницу.
Широкие таблицы клиентов сохраняют колонки и локальную горизонтальную
прокрутку; на телефонах направление прокрутки обозначено подсказкой и
затуханием правого края.
